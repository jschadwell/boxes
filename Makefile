...
SRCS=nest.cpp BoxConfigParser.cpp BoxConfigurator.cpp BoxConfiguration.cpp BoxRepository.cpp Box.cpp pugixml.cpp
...
nest.o : nest.cpp BoxConfigParser.h BoxConfigurator.h BoxConfiguration.h BoxRepository.h
